                  ...
                  <div className="w-[1221px] h-[652px] rounded-[40px]" style={{ backgroundColor: 'rgba(187, 187, 187, 0.1)' }}>
                     ...
                     <div className="flex flex-row">
                        ...
                        <div className="flex flex-col">
                           ...
                           <div className="flex flex-row">
                              <img src="Group 11.jpg" alt="" className=" rounded-[10px] w-[124px] h-[112px] ml-[111px] mt-[172px] " />
                              <div className="flex flex-col">
                                 <p className="text-[40px] font-Commissioner font-bold text-[#FFFFFF] ml-[38px] mt-[175px] ">Song Name</p>
                                 <p className="text-[24px] font-Commissioner font-Semibold text-[#FFFFFF]  ml-[38px] mt-[5px] ">Artist</p>
